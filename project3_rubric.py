...
# For Project 3 we're making a Python module that uses APIs.
# Your finished program should load a module you created.
# The module should make use of three seperate APIs.
# Each API should have its own function within the program.
# When the program runs, the user should be able to call an individual function or all of them.
...
#   a) Demo walk-through.
#   b) Does your module load?
#   c) Do all three API calls work?
#   d) Can you call all three APIs at once?
